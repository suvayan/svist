			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header card-header-info card-header-text">
					  <div class="card-text">
						<h4 class="card-title"><?php echo '<a href="'.base_url().'Teacher/viewProgram/?id='.base64_encode($prog[0]->id).'"><u>'.$prog[0]->title.' ('.$prog[0]->code.')</u></a> > '.$cdetails[0]->title.' ('.$cdetails[0]->c_code.')'; ?></h4>
					  </div>
					</div>
					<div class="card-body">
						...
						<a href="<?php echo base_url().'Teacher/liveClass/?id='.base64_encode($cdetails[0]->id); ?>" class="btn btn-sm btn-default"><i class="material-icons">class</i> Live Class</a>
						<button type="button" class="btn btn-sm btn-default" onClick="getBtnContent(<?php echo trim("'students', ".$cdetails[0]->id.", ".$prog[0]->id); ?>);"><i class="material-icons">people</i> Students</button>
						...
						<a href="<?php echo base_url('Teacher/message'); ?>" class="btn btn-sm btn-default"><i class="material-icons">email</i></a>
						<a href="<?php echo base_url('Teacher/addCourse/?prog='.base64_encode($prog[0]->id).'&cid='.base64_encode($cdetails[0]->id)); ?>" class="btn btn-sm btn-default"><i class="material-icons">settings</i></a>
					</div>
...
<script>
	...
	function getBtnContent(page, cid, prog)
	{
		...
		$.ajax({
			...
			type: 'GET',
			url: baseURL+"Teacher/getMenuContent",
