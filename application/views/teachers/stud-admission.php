<?php
	echo '<h3 class="font-weigth-bold">Student admission list under: '.trim($prog[0]->criteria).'</h3>';
	if(trim($prog[0]->criteria)!=""){
		echo "<strong>Criteria: </strong>".trim($prog[0]->criteria);
	}else{
		echo "<strong>No criteria set..</strong>";
	}
	echo '<br><strong>Admission Last Date: </strong>'.date('jS M Y',strtotime($prog[0]->aend_date));
