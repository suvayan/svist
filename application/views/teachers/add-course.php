			...
			<div class="col-md-10 mx-auto">
				<div class="card ">
					<div class="card-header card-header-primary card-header-icon">
					  ...
					  <h4 class="card-title">Course <small class="text-danger">*'s are important</small>
					  <a href="<?php echo base_url().'Teacher/viewProgram/?id='.base64_encode($cd[0]->prog_id); ?>" class="btn btn-sm btn-primary pull-right"><i class="material-icons">list</i> Course List</a>
					  </h4>
					</div>
					<div class="card-body ">
							...
							<div class="row mb-3">
								<div class="col-sm-6">
									<div class="form-group">
										 ...
										 <input type="datetime-local" name="sdate" id="sdate" class="form-control" value="<?php echo $cd[0]->start_date; ?>">
									</div>
								</div>
								<div class="col-sm-6">
									<div class="form-group">
										 <label for="edate" class="">End Date</label>
										 <input type="datetime-local" name="edate" id="edate" class="form-control" value="<?php echo $cd[0]->end_date; ?>">
									</div>
								</div>
							</div>
							<div class="row mb-3">
