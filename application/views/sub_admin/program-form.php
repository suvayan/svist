<div class="content">
	<div class="container-fluid">
		<form action="<?php echo base_url('Subadmin/insertEditNewProgram'); ?>" enctype="multipart/form-data" id="frmProgram" method="POST" style="width: 100%;">
		<div class="row">
                                    ...
                                    <select class="selectpicker" data-style="select-with-transition" data-title="Select department <span class='text-danger'>*</span>" id="dept" name="dept">
                                        <?php
                                            foreach($department as $dept){
                                                echo '<option value="'.$dept->id.'" '.(($dbp[0]->id==$dept->id)?'selected':'').'>'.$dept->title.'</option>';
                                            }
                                        ?> 
                                    </select>
                                </div>     
