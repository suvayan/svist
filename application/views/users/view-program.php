					...
					<div class="col-lg-12">
						<div class="card ">
							<div class="card-header card-header-primary card-header-text">
							  <div class="card-text">
								<h4 class="card-title"><?php echo $prog[0]->title; ?></h4>
							  </div>
							 <a href="<?php echo base_url().'Student'; ?>" class="btn btn-sm btn-primary pull-right"><i class="material-icons">list</i> My Programs</a>
							</div>
							<div class="card-body">
											...
											<table class="table table-striped table-no-bordered table-hover dtinsstrm" cellspacing="0" width="100%">
												...
												<tbody>
													<?php $i=1; foreach($pprof as $trow){ ?>
														<tr>
															<td><?php echo $i; ?></td>
															<td><?php echo '<i class="material-icons">verified</i> '.$trow->name; ?></td>
											...
											<li class="timeline-inverted" id="progc_<?php echo $cid; ?>">
											  ...
											  <div class="timeline-panel">
												<div class="timeline-heading">
												  <a href="<?php echo base_url().'Student/courseDetails/?cid='.base64_encode($cid).'&prog='.base64_encode($prog_id); ?>">
