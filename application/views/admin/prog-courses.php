			...
			<div class="col-md-12">
				<div class="card ">
					<div class="card-header card-header-primary card-header-text">
					  ...
					  <a href="<?php echo base_url().'Admin/programList'; ?>" class="btn btn-primary btn-sm pull-right"><i class="material-icons">list</i> Program List</a>
					  <a href="<?php echo base_url().'Admin/addCourse/?prog='.base64_encode($prog_id); ?>" class="btn btn-primary btn-sm pull-right"><i class="material-icons">add</i> Add Course</a>
					</div>
					<div class="card-body">
						<div class="row">
							<?php
											...
											echo '<div class="col-md-4" id="progc_'.$cid.'">
													<div class="card bg-light">
														...
														<div class="card-footer">';
															...
															echo '<a href="'.base_url('Admin/addCourse/?prog='.base64_encode($prog_id).'&cid='.base64_encode($cid)).'" class="btn btn-info btn-sm pull-right"><i class="material-icons">edit</i> Edit</a>
...
<script>
	function deleteCourse(cid)
	{
		Swal.fire({
		  ...
		  if (result.value) {
			  $.ajax({
				  url:baseURL+'Admin/deleteProgCourse',
				  type: 'GET',
				  data: {id: cid},
				  success: (res)=>{
					  if(res){
