			...
			<div class="col-md-10 mx-auto">
				<div class="card ">
					<div class="card-header card-header-primary card-header-icon">
					  ...
					  <a href="<?php echo base_url().'Admin/viewProgCourse/?pid='.base64_encode($cd[0]->prog_id); ?>" class="btn btn-sm btn-primary pull-right"><i class="material-icons">list</i> Course List</a>
					  </h4>
					</div>
					<div class="card-body ">
