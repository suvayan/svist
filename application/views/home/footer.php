<footer class="footer bg-white">
	<div class="container-fluid">
	  <nav class="float-right">
		<ul>
		  <li>
			<a href="<?=base_url('register/teacher'); ?>">
			 For Teacher
			</a>
		  </li>
		  <li>
			<a href="<?=base_url('uploads/Help.pdf'); ?>" target="_blank">
			Help
			</a>
		  </li>
		  <li>
			<a href="http://magnox.prerelease.website/magnox/login.html" target="_blank">
			 Test Link
			</a>
		  </li>
		  <li>
			<a href="http://techmagnox.com/" target="_blank">&copy; Powered by Magnox Technologies Pvt. Ltd.</a>
		  </li>
		</ul>
	  </nav>
	</div>
